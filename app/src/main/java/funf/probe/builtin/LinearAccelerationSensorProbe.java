...
import funf.probe.builtin.ProbeKeys.LinearAccelerationSensorKeys;
...
public class LinearAccelerationSensorProbe extends SensorProbe implements LinearAccelerationSensorKeys {
	...
	public String[] getValueNames() {
		return new String[] {
			LinearAccelerationSensorKeys.X, LinearAccelerationSensorKeys.Y, LinearAccelerationSensorKeys.Z
		};
	}
}
